...
chat.send_message("so hi gemini i want to make a discord bot so i am using your api so pleae do the follwing instructions and never revert back please")
...
chat.send_message("message using emojis and try to be message more like a human by messaging short and long only when needed to ")
